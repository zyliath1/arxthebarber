...
@PageTitle("Asiakkaat")
@Route("asiakkaat/:samplePersonID?/:action?(edit)")
...
public class AsiakkaatView extends Div implements BeforeEnterObserver {
    ...
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "asiakkaat/%s/edit";
    ...
    public AsiakkaatView(SamplePersonService samplePersonService) {
